        ...
        rows={[
          ...
          [
            ...
            <fbt desc="Docs table cell — ve keyframes arvia">
              {
                "`@keyframes name { from { } to { } }` — a raw at-rule; the name is literal, not hashed"
              }
            </fbt>,
          ],
          [
          ...
          [
            ...
            <fbt desc="Docs table cell — ve media arvia">
              {
                "nested raw `@media`/`@container` with token refs (`@media (min-width: breakpoint.md) { … }`) inside `base`"
              }
            </fbt>,
          ],
        ]}
      ...
      <DocUl>
        ...
        <DocLi>
          <fbt desc="Docs list item — ve adds responsive">
            {
              "[Responsive](/docs/responsive) and [container](/docs/container-queries) styling via raw `@media`/`@container` at-rules nested in the component, where token refs (`@media (min-width: breakpoint.md) { … }`) inline breakpoint and container-size values into the query bounds."
            }
          </fbt>
        </DocLi>
        <DocLi>
