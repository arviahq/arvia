        ...
        rows={[
          ...
          [
            ...
            <fbt desc="Docs table cell — tw responsive arvia">
              {"nested `@media (min-width: breakpoint.md) { flex-direction: row; }` in `base`"}
            </fbt>,
          ],
          [
            "dark:bg-zinc-900",
          ...
          [
            ...
            <fbt desc="Docs table cell — tw container arvia">
              {
                "`container-type: inline-size` + nested `@container (min-width: container-size.wide) { … }`"
              }
            </fbt>,
          ],
          [
      ...
      <DocUl>
        ...
        <DocLi>
          <fbt desc="Docs list item — tw gotcha responsive">
            {
              "Responsiveness is plain CSS, nested in the component. Instead of breakpoint-prefixed utilities, nest a raw `@media (min-width: breakpoint.md) { … }` (or `@container (min-width: container-size.wide) { … }`) inside `base` — a breakpoint or container-size token reference inlines to its value as the query bound."
            }
          </fbt>
        </DocLi>
      </DocUl>
